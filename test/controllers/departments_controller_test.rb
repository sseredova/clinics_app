...
class DepartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create department" do
    assert_difference('Department.count') do
      post departments_url, params: { department: { clinic_id: @department.clinic_id, name: @department.name } }
    end
  ...
  test "should update department" do
    patch department_url(@department), params: { department: { clinic_id: @department.clinic_id, name: @department.name } }
