...
class PatientCardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create patient_card" do
    assert_difference('PatientCard.count') do
      post patient_cards_url, params: { patient_card: { clinic_id: @patient_card.clinic_id, number: @patient_card.number } }
    end
  ...
  test "should update patient_card" do
    patch patient_card_url(@patient_card), params: { patient_card: { clinic_id: @patient_card.clinic_id, number: @patient_card.number } }
